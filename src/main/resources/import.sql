...
# SUPPLIER, DRIVER
INSERT INTO crum_db.supplier (company_address,company_code,company_description,company_name,fax,rating_value,tin,website,user_id) VALUES ('210 Doi can, Ha Noi, Viet Nam','APL','Hang tau APL','Pacific Mail Steamship Company','25688','0.2','1232223','apl.com','3');
INSERT INTO crum_db.supplier (company_address,company_code,company_description,company_name,fax,rating_value,tin,website,user_id) VALUES ('Bonn, Germany','DHL','DHL is an American-founded German courier, parcel, and express mail service.','DHL Express','11111','0.5','1232423','dhl.com','4');
INSERT INTO crum_db.supplier (company_address,company_code,company_description,company_name,fax,rating_value,tin,website,user_id) VALUES ('200 Quang Trung, Ha Dong, Ha Noi, Viet Nam','TAP','Xuat khau cac thiet bi dien may','Tan An Phat','25688','0.2','1232223','tapvn.com','5');
...
# TRAILER & TRACTOR
INSERT INTO crum_db.vehicle(id,created_at,license_plate,number_of_axles,updated_at,user_id) VALUES (1,'2020-07-12 00:48:56','112222',2,'2020-07-12 00:48:56',4),(2,'2020-07-12 00:49:22','1122223',2,'2020-07-12 00:49:22',4);
